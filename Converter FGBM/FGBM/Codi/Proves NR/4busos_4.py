...
for cc in range(n_iter):
    ...
    J[8, 8] = 0
    J[8, 9] = V3 * np.cos(d3) * V4 * np.cos(d4) * (r3 * np.cos(th) - x3 * np.sin(th)) - V3 * np.sin(d3) * V4 * np.cos(d4) * (x3 * np.cos(th) + r3 * np.sin(th)) + V3 * np.cos(d3) * V4 * np.sin(d4) * (x3 * np.cos(th) + r3 * np.sin(th)) + V3 * np.sin(d3) * V4 * np.sin(d4) * (r3 * np.cos(th) - x3 * np.sin(th))
    J[8, 10] = 0
    ...
    J[9, 8] = 0
    J[9, 9] = V3 * np.cos(d3) * V4 * np.cos(d4) * (x3 * np.cos(th) + r3 * np.sin(th)) + V3 * np.sin(d3) * V4 * np.cos(d4) * (r3 * np.cos(th) - x3 * np.sin(th)) - V3 * np.cos(d3) * V4 * np.sin(d4) * (r3 * np.cos(th) - x3 * np.sin(th)) + V3 * np.sin(d3) * V4 * np.sin(d4) * (x3 * np.cos(th) + r3 * np.sin(th))
    J[9, 10] = 0
