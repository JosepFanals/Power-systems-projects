...
M = np.array([[ctheta[0], 0, V[0], 0, 0, 0], 
              [1, V[0], 0, 0, 0, 0],
              [-G * ctheta[0] + B * stheta[0], 0, -G * V[0], B * V[0], G * U, - B * U],
              [-G * stheta[0] - B * ctheta[0], 0, -B * V[0], -G * V[0], B * U, G * U],
              [0, 0, 2 * ctheta[0], 2 * stheta[0], 0, 0],
              [0, 0, 0, 0, 2 * cdelta[0], 2 * sdelta[0]]
              ])
